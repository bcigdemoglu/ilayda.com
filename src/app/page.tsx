        ...
        <div className="text-center lg:m-7 mt-10 w-80 p-3">
          <form className="space-y-6" action="#" method="POST">
            <div>
              <label
                htmlFor="email"
                className="block text-slate-100  font-light text-sm leading-6"
              >
                {newsletterheading}
              </label>
              <div className="mt-2 flex-col flex lg:flex md:flex-row">
                ...
                />
                <button className="ml-0 bg-slate-950 sm:w-auto border-slate-100	rounded-none mt-2 md:mt-0	p-2 border-2 text-white">
                  Subscribe
                </button>
              </div>
            </div>
